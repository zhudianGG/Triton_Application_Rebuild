...
def generateInterface():
    ...
    for i in range(size):
        ...
        response_dict['value'] = result['safety_code']
        unsafe_predict = result['ordered_unsafe_predicts'][0]
        model_output = {'safe_score': result['safety_score'], 'unsafe_category': unsafe_predict['label'], 'unsafe_score': unsafe_predict['score']}
